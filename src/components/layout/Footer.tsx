    ...
    <footer className="bg-white border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-4 text-xs font-bold text-gray-500 hover:text-gray-900 transition-colors uppercase tracking-wider"
        >
          ...
          {isExpanded && (
            ...
            >
              <div className="pt-2 pb-6">
                ...
                {/* Mobile Accordions */}
                <div className="lg:hidden space-y-2 mb-6 border-t border-gray-50 pt-6">
                  {Object.entries(footerLinks).map(([key, links]) => (
        ...
        <div className="py-4 border-t border-gray-100 flex flex-col lg:flex-row items-center justify-between gap-4">
