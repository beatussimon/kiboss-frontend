...
export default function RideCard({ ride, distance = null, lastRideElementRef }: RideCardProps) {
    return (
        <Link ref={lastRideElementRef} to={`/rides/${ride.id}`} className="group cursor-pointer">
            <div className="flex flex-col md:flex-row overflow-hidden h-full rounded-[2rem] border border-gray-100/80 dark:border-gray-700 shadow-sm hover:shadow-2xl transition-all duration-500 hover:border-primary-100 dark:hover:border-primary-800 bg-white dark:bg-gray-800 min-h-[300px]">
                {/* Image Half */}
                <div className="md:w-[45%] h-56 md:h-auto relative bg-gray-900 overflow-hidden shrink-0">
                    ...
                    {/* Time floating badge */}
                    <div className="absolute top-4 right-4 bg-gray-900 px-4 py-2 rounded-2xl text-right border border-gray-700 shadow-xl">
                    ...
                    <div className="absolute bottom-5 left-5 right-5 z-10">
                        <div className="flex flex-col gap-3 relative before:absolute before:left-3 before:top-3 before:bottom-3 before:w-px before:bg-gradient-to-b before:from-primary-500 before:to-gray-400">
                            <div className="flex items-center gap-4 relative">
                                <div className="w-6 h-6 rounded-full bg-gray-900 border border-gray-700 flex items-center justify-center shrink-0 shadow-lg">
                ...
                {/* Info Half */}
                <div className="md:w-[55%] p-6 flex flex-col justify-between bg-white dark:bg-gray-800 relative">

                    <div className="flex justify-between items-start mb-4">
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors line-clamp-2 pr-4 leading-tight tracking-tight">
                            {ride.route_name}
                        </h3>
                        <div className="text-right shrink-0 bg-primary-50/50 dark:bg-primary-900/20 px-4 py-2 rounded-2xl border border-primary-100/50 dark:border-primary-800/50">
                    ...
                    <div className="flex items-center gap-3 mt-2 mb-6 group/driver cursor-pointer" onClick={(e) => {
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-sm font-bold text-gray-900 dark:text-white group-hover/driver:text-primary-600 transition-colors leading-none truncate max-w-[150px] flex items-center gap-1">
                                {(ride as any).driver?.corporate_profile?.verification_status === 'VERIFIED'
                    ...
                    <div className="mt-auto space-y-4">
                        <div className="flex flex-wrap gap-2">
                            <div className="flex items-center gap-1.5 px-3 py-1.5 bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-100/50 text-xs font-bold text-gray-700 dark:text-gray-200">
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-gray-100/60 dark:border-gray-700">
                            ...
                            <div className="text-[11px] font-black text-white bg-gray-900 dark:bg-white dark:text-gray-900 px-4 py-2 rounded-xl group-hover:bg-primary-600 dark:group-hover:bg-primary-500 group-hover:text-white transition-colors shadow-sm">
                                View Journey
                            </div>
                        </div>
                    </div>
